...
<div class="admin-container">
    <div class="admin-header">
        <div class="header-content">
            ...
            <p class="admin-subtitle">Update the details for {{ $product->name }}</p>
    ...
    <div class="form-container">
        <div class="form-card">
            <div class="form-header">
                ...
                <p>Modify the fields below to update this product</p>
            </div>
            ...
            <div class="preview-body">
                <div class="current-image">
                    ...
                    <div class="image-info">
                        ...
                        <p class="image-dimensions">Product Image</p>
                    </div>
                </div>
            </div>
        </div>
